...
if(isset($_POST['login']))
{
	...
	if($email!=""&&$pass!="")
	{
		$query = oci_parse($con, "SELECT * FROM Cashier WHERE Cashier_Email= '$email' AND Cashier_Password = '$pass' And Cashier_Status='Approved' ");
		oci_execute($query);
...
<head>
    ...
    <title>cleaner login page</title>
    ...
    <div class="col-md-12">
        <div class="row">
            ...
            <div class="col-md-6 jumbotron my-3">
                <h5 class="text-center my-2">Cashier Login</h5>
