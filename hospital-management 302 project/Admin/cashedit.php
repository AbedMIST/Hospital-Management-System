...
<div class="container-fulid">
    ...
    <div class="row">
        <div class="col-md-10">
                ...
                <div class ="col-md-10">
                <h5 class="text-center">Edit Cashier</h5>
                <?php
                if(isset($_GET['id']))
                {
                                    $id = $_GET['id'];
                ...
                <div class="row">
                <div class="col-md-8">
                <h5  class="text-center">Cashier Details</h5>
                ...
                <h5 class="my-3">Qualification:<?php echo $row[9];?> </h5>
                ...
                if(isset($_POST['update']))
                {
                    ...
                    $salary = $_POST['salary'];
                    $shift =$_POST['shift'];
                    $query = "UPDATE Cashier SET Cashier_Salary= $salary, Cashier_Shift='$shift'  where Cashier_Id=$id";
                    $stid = oci_parse($con, $query);
                    oci_execute($stid);
