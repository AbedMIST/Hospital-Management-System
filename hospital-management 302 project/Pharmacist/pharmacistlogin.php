...
if(isset($_POST['login']))
{
	...
	if($email!=""&&$pass!="")
	{
		$query = oci_parse($con, "SELECT * FROM Pharmacist WHERE Pharmacist_Email= '$email' AND Pharmacist_Password = '$pass' AND Pharmacist_Status='Approved' ");
		oci_execute($query);
        ...
        $name=$row[11];
			...
			$_SESSION['pharmacist']=$email;
            $_SESSION['pharmacist_Id']=$id;
            $_SESSION['pharmacist_name']= $name;
    ...
    <div class="col-md-12">
        <div class="row">
            ...
            <div class="col-md-6 jumbotron my-3">
                <h5 class="text-center my-2">Pharmacist Login</h5>
